...
import { fmtDate, fmtDuration, fmtNum, num, round2, todayISO, qtyDisplay, monthKey, firstOfMonthISO, accountHolderOf, accountHolderNames, customerNames, sameHolder } from '../utils.js'
...
export default function Reports() {
  ...
  const custOk = (c) => (!customer || c === customer) && (!accountHolder || sameHolder(accountHolderOf(db, c), accountHolder))
      ...
      <div className="card">
        <div className="spread" style={{ marginBottom: 12 }}>
          <div className="row">
            ...
            <Select value={accountHolder} onChange={(v) => { setAccountHolder(v); if (v && !sameHolder(accountHolderOf(db, customer), v)) setCustomer('') }} options={accountHolderNames(db)} placeholder="All account holders" style={{ width: 190 }} />
          </div>
          <div className="row">
